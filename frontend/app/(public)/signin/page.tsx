      ...
      <div className={style.auth}>
        ...
        <div className={style.details}>
          ...
          <form className={style.inputs}>
            <div className={style.input__container}>
              ...
              <input
                ...
                {...register('email', {
                  ...
                  pattern: { value: regex, message: 'Please enter a valid email address' },
                  minLength: { value: 6, message: 'minimum length must be at least 6 characters' },
                })}
                placeholder='Email'
              />
            </div>
            ...
            <button onClick={handleSubmit(onSubmit)} className={style.button}>Sign in</button>
          </form>
